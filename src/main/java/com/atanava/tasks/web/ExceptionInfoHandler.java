...
import com.atanava.tasks.util.ValidationUtil;
import com.atanava.tasks.util.exception.ErrorInfo;
...
import static com.atanava.tasks.util.exception.ErrorType.*;
...
public class ExceptionInfoHandler {
    ...
    public static final String EXCEPTION_INCORRECT_MODIFICATION_DATETIME = "exception.modifiedBeforeCreated";
    public static final String EXCEPTION_INCORRECT_COMPLETION_DATETIME = "exception.completedBeforeCreatedOrModified";

    private static final Map<String, String> CONSTRAINS_I18N_MAP = Map.of(
            "chk_modified", EXCEPTION_INCORRECT_MODIFICATION_DATETIME,
            "chk_completed", EXCEPTION_INCORRECT_COMPLETION_DATETIME);
